...
//                }
            ...
            adListener.onAdFailedToLoad(new LoadAdError(3, e.getMessage(), e.getCause().toString(), null, null));
        }
    }
    ...
    private void requestAd(){
        try {
            ...
            adListener.onAdFailedToLoad(new LoadAdError(0, e.getMessage(), e.getCause().toString(), null, null));
        }
    }
